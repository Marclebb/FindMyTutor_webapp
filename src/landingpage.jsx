...
import tutor from './assets/landingimage.jpg'
    ...
    <div className="font-sans bg-gray-50">
      <div className="grid md:grid-cols-2 items-center md:gap-8 gap-6">
        <div className="max-md:order-1 max-md:text-center z-50 relative">
          ...
          <p className="text-gray-600 mt-6 text-base leading-relaxed p-5">Finding you perfect tutor was never that easy, just make a post , wait for your perfect match , and the rest is on us!</p>
        ...
        <div className="lg:h-[550px] md:h-[550px] flex items-center relative max-md:before:hidden before:absolute before:bg-[#fbcb43] before:h-[120%] before:w-[120%] before:right-0 before:z-0">
          <img src={tutor} className="rounded-md sm:w-full z-50 relative " alt="Dining Experience" />
        </div>
      </div>

      <div className="grid md:grid-cols-3 gap-4 z-50 relative md:px-4 max-md:mt-12 bg-gray-100">
        <div className="bg-white p-6 shadow rounded-md mb-5">
          ...
          <h3 className="text-gray-800 text-xl font-bold mb-2">Browse</h3>
          <p className="text-sm text-gray-600">Browse from all the posts</p>
        ...
        <div className="bg-white p-6 shadow rounded-md mb-5">
          ...
          <h3 className="text-gray-800 text-xl font-bold mb-2">Customize</h3>
          <p className="text-sm text-gray-600">Make your customized request</p>
        ...
        <div className="bg-white p-6 shadow rounded-md mb-5">
          ...
          <h3 className="text-gray-800 text-xl font-bold mb-2">Match</h3>
          <p className="text-sm text-gray-600">Wait for the right match and contact your tutor</p>
