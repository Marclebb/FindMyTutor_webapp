...
router.get('/postinfo', async (req, res) => {
    try {
        ...
        const [courseData, dateData, timeData, locationData, learning_wayData, platformData, learning_methodData, priceData] = await Promise.all([
...
router.post('/submitpost', verifyJWT, (req, res) => {
    const { course_id, date_id, time_id, location_id, learning_way_id, platform_id, learning_method_id, price_id, post_description, post_type } = req.body;
    const user_id = req.userId;
    
    db.query("INSERT INTO posts (user_id, course_id, date_id, time_id, location_id, learning_way_id, platform_id, learning_method_id, price_id, post_description, post_type) VALUES (?,?,?,?,?,?,?,?,?,?,?)", 
    [user_id, course_id, date_id, time_id, location_id, learning_way_id, platform_id, learning_method_id, price_id, post_description, post_type], (err, result) => {
        if (err) {
            console.log(err);
